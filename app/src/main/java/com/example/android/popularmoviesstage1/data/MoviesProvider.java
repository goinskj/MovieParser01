...
public class MoviesProvider extends ContentProvider {
     ...
     * CODE_MOVIES_WITH_ constants defined above.
     * <p>
    ...
    public static UriMatcher buildUriMatcher() {
         ...
         * they aren't going to change. In Movies, we use CODE_MOVIE or CODE_MOVIE_WITH_?.
         */
    ...
    /**
     * Handles requests to insert a set of new rows. In Movies, we are only going to be
     * inserting multiple rows of data at a time from a movie. There is no use case
    ...
    /**
     * Handles query requests from clients. We will use this method in Movies to query for all
     * of our movie data.
     *
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        throw new RuntimeException(
                "We are not implementing insert in Movies. Use bulkInsert instead");
    }
